 ...
 * Use the [NoInternetConnectionFragment.newInstance] factory method to
...
class NoInternetConnectionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment NoInternetConnectionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            NoInternetConnectionFragment().apply {
